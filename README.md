...
| C++ with a better syntax	 | The only thing better than not having to manage memory is feeling morally superior about it.	  |  Nerfed Rust for the web  |  Because who needs readable syntax? |  Because you're not a real programmer until you've compiled something from a text editor	  | For when you need to glue things together, but also want to eat the glue |
